        ...
        <Bottom>
          <Info>
            <Product>
              <ProductDetail>
                <Image
                  src={require("../assets/Be Kind Crew Neck Sweatshirt.png")}
                />
                <Details>
                  <ProductName>
                    <b>Item:</b>Be Kind Sweatshirt
                  </ProductName>
                  <ProductId>
                    <b>ID:</b>4905979804
                  </ProductId>
            ...
            <Product>
              <ProductDetail>
                <Image src={require("../assets/Adopt.png")} />
                <Details>
                  <ProductName>
                    <b>Item:</b>Adopt Sweatshirt
                  </ProductName>
                  <ProductId>
                    <b>ID:</b>8580324080
                  </ProductId>
            ...
            <Product>
              <ProductDetail>
                ...
                <Details>
                  <ProductName>
                    <b>Item:</b>Rich In Faith Unisex Shirt
                  </ProductName>
                  <ProductId>
                    <b>ID:</b>29080451119
                  </ProductId>
